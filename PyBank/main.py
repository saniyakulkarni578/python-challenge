...
os.makedirs(analysis_dir, exist_ok=True)   # Create analysis directory if it doesn't exist

# Define files to load and output
file_to_load = os.path.join(resources_dir, "budget_data.csv")  # Input file path
file_to_output = os.path.join(analysis_dir, "budget_analysis.txt")  # Output file path
